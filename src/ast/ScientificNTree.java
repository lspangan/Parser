...
/**
 *  @param tok is the Token containing the String representation of the scientificN
 *  literal; we keep the String rather than converting to an integer value
 *  so we don't introduce any machine dependencies with respect to scientificN
 *  representations
*/
