...
*/
    public void print(String s,AST t) {
        ...
        visitKids(t);
        indent -= 2;
        //System.out.println("Found:" + tokenFound);
    }
    ...
    public Object visitUnaryOpTree(AST t) { print("UnaryOp: "+((UnaryOpTree)t).getSymbol().toString(),t);  return null; }
    public Object visitPowerOpTree(AST t) { print("PowerOp: "+((PowerOpTree)t).getSymbol().toString(),t);  return null; }
