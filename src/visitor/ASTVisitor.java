...
public abstract class ASTVisitor {
    ...
    public abstract Object visitFloatTypeTree(AST t); // added
    public abstract Object visitCharTypeTree(AST t); // added
    public abstract Object visitStringTypeTree(AST t); // added
    public abstract Object visitDoTree(AST t); // added
    public abstract Object visitForTree(AST t); // added
    public abstract Object visitEHeadTree(AST t); // added
    public abstract Object visitFloatTree(AST t); // added
    public abstract Object visitCharTree(AST t); // added
    public abstract Object visitScientificNTree(AST t); // added
    public abstract Object visitStringTree(AST t); // added
    public abstract Object visitScientificNTypeTree(AST t); // added
    public abstract Object visitUnaryOpTree(AST t); // added
    public abstract Object visitPowerOpTree(AST t); // added
